...
//* fire window load event
    ...
    if(localStorage.getItem("theme") == "dark"){
        ...
        quote_Left.forEach(el=>{
            el.src = "./static/img/quote-sign-left - light.webp"
        })
       quote_Right.forEach(el=>{
           el.src = "./static/img/quote-sign-right - light.webp"
       })
       ...
       // User prefers light theme
        ...
        quote_Left.forEach(el=>{
            el.src = "./static/img/quote-sign-left.webp"
        })
        quote_Right.forEach(el=>{
            el.src = "./static/img/quote-sign-right.webp"
        })
